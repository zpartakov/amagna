...
function sortieRSS($id, $titre, $date, $provenance)
	{
	 echo "
	   <item>
	    ...
	    <link>http://www.picadametles.ch/atable20/view/" .$id ."</link>
 ...
 */
	...
	echo '<?xml-stylesheet title="XSL formatting" type="text/xsl" href="http://www.picadametles.ch/atable20/recettes/rss" ?><rss version="2.0"
...
?>
  <channel>
  <title>Recettes de cuisine picadametles.ch</title>
  <link>http://www.picadametles.ch/atable20/</link>
  <atom:link href="http://www.picadametles.ch/atable20/recettes/rss" rel="self" type="application/rss+xml"/>
  <description>Les recettes de cuisine de A table! sur picadametles.ch</description>
